...
import { imgData,recentModels,recentTagger,recentlyUpdated } from '../components/img/img'
...
const DashBoard = () => {
    ...
    const [taggerProfile, settaggerProfile] = useState(recentTagger)
    const [modelProfile, setmodelProfile] = useState(recentModels)
    ...
    // for(let i=0; i< recentTagger.length; i++){
    //     taggerProfile.push(
    //     <div className='taggersProfile' key={recentTagger[i].id}>
    //         <div className="img"><img src={recentTagger[i].src} alt="" /></div>
    //         <h3>{recentTagger[i].name}</h3>
    ...
    //     modelProfile.push(
    //     <div className='taggersProfile' key={modelProfile[i].id}>
    //         <div className="img"><img src={modelProfile[i].src} alt="" /></div>
    //         <h3>{modelProfile[i].name}</h3>
    //         <p>12 hours ago</p>
    //         <div className="btnContainer"><button>View profile</button></div>
    //     </div>
    //     )
    ...
    for(let i=0; i< recentlyUpdated.length; i++){
        recentUpdates.push(
        <div className="recentlyUpdatedModels" key={recentlyUpdated[i].id}>
        <div className="wrapper">
           <div className="img"><img src={recentlyUpdated[i].src} /></div>
           <div className="modelInfo">
                <h3>{recentlyUpdated[i].name}</h3>
                <p>21 ruthy,Us</p>
           </div>
        </div>
            ...
            <div className="generalTaggerInfoWrapper">
                <div className="generalTaggerInfo">
                    ...
                    <div className='taggersProfileWrapper'>
                        {
                            taggerProfile.map(item=>{
                            return   <div className='taggersProfile' key={item.id}>
