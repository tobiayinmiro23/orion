...
const AllUsers = ({handleMenu,mode,setpage}) => {
  return (
                            ...
                            <div className='deleteIconWrapper'>
                                {
                                    mode
                                    ?
                                    <div className="img" onClick={()=>handleMenu(true)}><img src="/img/delete (1).png" alt="" /></div>
                                    :
                                    <div className="img" onClick={()=>handleMenu(true)}><img src="/img/delete.png" alt="" /></div>
                                }
                            </div>
